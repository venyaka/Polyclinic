...
public class MailUtils {
    ...
    public static final String ACCOUNT_VERIFY_HEADER = "Верификация аккаунта Polyclinic";

    public static final String ACCOUNT_CHANGE_PASSWORD_HEADER = "Изменение пароля аккаунта Polyclinic";
